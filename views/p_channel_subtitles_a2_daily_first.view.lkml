view: p_channel_subtitles_a2_daily_first {
  sql_table_name: `pieteryoutube.p_channel_subtitles_a2_daily_first`
    ;;
  ...
  dimension: subtitle_language_autotranslated {
    type: string
    description: "This dimension identifies the auto-translated closed caption language used for the longest time during the view."
    sql: ${TABLE}.subtitle_language_autotranslated ;;
  }
